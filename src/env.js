...
Sk.bool_check = function (variable, name) {
  ...
  */
  ...
  Sk.configure = function (options) {
    ...
    Sk.asserts.assert(typeof Sk.turtle_textinput === "function" || Sk.turtle_textinput === "undefined");
  
    Sk.turtle_numinput = options["turtle_numinput"] || Sk.turtle_numinput;
    Sk.asserts.assert(typeof Sk.turtle_numinput === "function" || Sk.turtle_numinput === "undefined");
