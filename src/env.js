...
Sk.configure = function (options) {
	...
	Sk.asserts.assert(
		typeof Sk.turtle_textinput === "function" ||
			Sk.turtle_textinput === "undefined"
	);

	Sk.turtle_numinput = options["turtle_numinput"] || Sk.turtle_numinput;
	Sk.asserts.assert(
		typeof Sk.turtle_numinput === "function" ||
			Sk.turtle_numinput === "undefined"
	);

	// Sk.fillBgColor = options["fillBgColor"] || Sk.fillBgColor;
	// Sk.asserts.assert(
	// 	typeof Sk.fillBgColor === "function" || Sk.fillBgColor === "undefined"
	// );
	...
	Sk.asserts.assert(
		typeof Sk.filewrite === "function" || typeof Sk.filewrite === "undefined"
	);
	...
	Sk.retainGlobals =
		options["retainglobals"] || options["retainGlobals"] || false;
...
(function () {
	...
	if (Sk.global["write"] !== undefined) {
		...
		Sk.global["console"] !== undefined &&
		Sk.global["console"]["log"] !== undefined
	) {
		Sk.output = function (x) {
